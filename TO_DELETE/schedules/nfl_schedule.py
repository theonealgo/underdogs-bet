...
NFL schedule data for the 2025 season.
Updates once per season.
"""
...
if __name__ == '__main__':
    ...
    print(f"NFL Schedule: {len(schedule)} games loaded")
    print(f"Sample game: {schedule[0]}")
