...
def parse_date(date_str):
    ...
    # Strip whitespace and get date part only (before any space/time)
...
def get_upcoming_predictions(sport, days=30):
    ...
    for game in upcoming_games:
        ...
        if game_date and start_date <= game_date <= end_date:
            ...
            # Combined differential (defense + offense) - SIMPLE MODEL
            total_diff = goalie_diff * 0.5 + offense_diff * 0.5
            
            # ML models with comprehensive differential - SIMPLE MODEL
